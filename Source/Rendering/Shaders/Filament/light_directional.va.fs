...
//#if VA_RM_SPECIAL_EMISSIVE_LIGHT
    light.AddToEmissive     = false; // no special emissive for directional lights (makes no sense I think? although it might in some cases?)
//#endif
...
//#endif
            ...
            visibility *= computeMicroShadowing( light.NoL, shading.CombinedAmbientOcclusion );
        }
